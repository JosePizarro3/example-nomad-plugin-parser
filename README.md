# nomad-nomad-example-plugin-parser

A example of the NOMAD plugin parser structure.
...
```
pip install dist/nomad-nomad-example-plugin-parser-0.1.0
```
...
### License
Distributed under the terms of the `Apache Software License 2.0`_ license, "nomad-nomad-example-plugin-parser" is free and open source software
